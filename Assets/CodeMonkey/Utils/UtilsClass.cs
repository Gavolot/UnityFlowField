...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static void InitRandomSeedByDateTimeTicks()
        {
        ...
        // Create Text in the World
        public static TextMesh CreateWorldTextId(string idName, Transform parent, string text, Vector3 position, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder)
        {
            GameObject gameObject = new GameObject("debugTextGridMap", typeof(TextMesh));
            Transform transform = gameObject.transform;
